  ...
  return (
    ...
    <div className="hero-container">
      <div className="side-image">
        ...
        <p>71 Madison Ave, New York, NY 10016,
. reservations@fidalgo.com</p>
      </div>
      ...
      <div className="main-image">
        <img
          ...
          style={{
            ...
            opacity: visible ? 1 : 0,
            transition:
              "transform 0.6s cubic-bezier(0.25, 0.46, 0.45, 0.94), opacity 0.6s ease-out, box-shadow 0.4s ease",
          }}
        />
      </div>
